...
IFontDisp = Font
__all__ = [ 'OLE_YPOS_PIXELS', 'FONTBOLD', 'Checked',
           'OLE_YSIZE_CONTAINER', 'Unchecked', 'OLE_COLOR',
           'OLE_YSIZE_PIXELS', 'OLE_CANCELBOOL', 'OLE_HANDLE',
           'OLE_XSIZE_PIXELS', 'IFontDisp', 'Monochrome', 'VgaColor',
           'Font', 'OLE_XPOS_PIXELS', 'OLE_YPOS_HIMETRIC',
           'IFontEventsDisp', 'OLE_XPOS_HIMETRIC', 'FONTSIZE',
           'FONTNAME', 'IFont', 'Picture', 'FontEvents', 'Gray',
           'OLE_XSIZE_CONTAINER', 'FONTUNDERSCORE', 'StdFont',
           'FONTSTRIKETHROUGH', 'Color', 'Default', 'IPictureDisp',
           'OLE_YSIZE_HIMETRIC', 'OLE_TRISTATE', 'OLE_XPOS_CONTAINER',
           'IPicture', 'OLE_OPTEXCLUSIVE', 'OLE_ENABLEDEFAULTBOOL',
           'FONTITALIC', 'StdPicture', 'LoadPictureConstants',
           'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_CONTAINER']
from comtypes import _check_version; _check_version('1.1.10', 1489870670.859214)
